...
#[callable_impl]
impl PathContext {
    #[docs(name = "path.string", description = "Full path as string", example = "print file.path.string")]
    #[property]
    pub fn string(&self) -> String {
        self.path_buf.to_string_lossy().to_string()
    }
    
    #[docs(name = "path.basename", description = "Base name of the file without extension", example = "print file.path.basename")]
    #[property]
    ...
    #[docs(name = "path.extension", description = "File extension", example = "print file.path.extension")]
    #[property]
    ...
    #[docs(name = "path.parent", description = "Parent directory path", example = "print \"Dir: \" + file.path.parent")]
    #[property]
    ...
    #[docs(name = "path.filename", description = "File name with extension", example = "print file.path.filename")]
    #[property]
    ...
    #[docs(name = "join", description = "Joins path components", example = "file.path.join(\"subdir\")")]
    #[method]
...
#[callable_impl]
impl FileContext {
    #[docs(name = "file.name", description = "File name with extension", example = "print file.name")]
    #[property]
    ...
    #[docs(name = "file.basename", description = "Base name of the file without extension", example = "print file.basename")]
    #[property]
    pub fn basename(&self) -> String {
        self.path_buf
            .file_stem()
    ...
    #[docs(name = "file.extension", description = "File extension", example = "print file.extension")]
    #[property]
    pub fn extension(&self) -> String {
        self.path_buf
            .extension()
    ...
    #[docs(name = "file.dirname", description = "Directory name of the file", example = "print file.dirname")]
    #[property]
    ...
    #[docs(name = "exists", description = "Checks if the file exists", example = "if file.exists { print \"File exists\" }")]
    #[method]
...
impl GitContext {
    ...
    #[docs(name = "git.branch", description = "Current Git branch information", example = "print git.branch.name")]
    #[property]
    pub fn is_merge_commit(&self) -> bool {
        self.is_merge_commit
    }
    
    #[docs(name = "git.has_conflicts", description = "Checks if there are merge conflicts", example = "if git.has_conflicts { warn \"Resolve conflicts first\" }")]
    #[property]
...
#[callable_impl]
impl BranchInfo {
    #[docs(name = "git.branch.name", description = "Current Git branch name", example = "if git.branch.name == \"main\" { warn \"Direct push to main\" }")]
    #[property]
    pub fn name(&self) -> String {
        self.name.clone()
    }
    
    #[docs(name = "is_main", description = "Checks if the current branch is main or master", example = "if git.branch.is_main { print \"On main branch\" }")]
    #[property]
...
#[callable_impl]
impl CommitInfo {
    #[docs(name = "git.commit.message", description = "Git commit message", example = "print git.commit.message")]
    #[property]
    pub fn message(&self) -> String {
        self.message.clone()
    }
    
    #[docs(name = "git.commit.hash", description = "Git commit hash", example = "print git.commit.hash")]
    #[property]
...
#[callable_impl]
impl AuthorInfo {
    #[docs(name = "git.author.name", description = "Git author name", example = "print git.author.name")]
    #[property]
    pub fn name(&self) -> String {
        self.name.clone()
    }
    
    #[docs(name = "git.author.email", description = "Git author email address", example = "print git.author.email")]
    #[property]
...
impl RemoteInfo {
    ...
    #[docs(name = "git.remote.name", description = "Git remote name", example = "print git.remote.name")]
    #[property]
    pub fn name(&self) -> String {
        self.name.clone()
    }
    
    #[docs(name = "git.remote.url", description = "Git remote URL", example = "print git.remote.url")]
    #[property]
...
impl DiffStats {
    ...
    #[docs(name = "git.stats.files_changed", description = "Number of files changed in the diff", example = "print git.stats.files_changed")]
    #[property]
    pub fn files_changed(&self) -> f64 {
        self.files_changed as f64
    }
    
    #[docs(name = "git.stats.additions", description = "Number of additions in the diff", example = "print git.stats.additions")]
    #[property]
    pub fn additions(&self) -> f64 {
        self.additions as f64
    }
    
    #[docs(name = "git.stats.deletions", description = "Number of deletions in the diff", example = "print git.stats.deletions")]
    #[property]
    pub fn deletions(&self) -> f64 {
        self.deletions as f64
    }
    
    #[docs(name = "git.stats.modified_lines", description = "Total number of modified lines (additions + deletions)", example = "print git.stats.modified_lines")]
    #[property]
...
impl StringContext {
    ...
    #[docs(name = "string.length", description = "Length of the string", example = "print \"hello\".length")]
    #[property]
...
impl NumberContext {
    ...
    #[docs(name = "number.abs", description = "Absolute value of the number", example = "print (-5).abs")]
    #[method]
    pub fn abs(&self) -> f64 {
        self.value.abs()
    }
    
    #[docs(name = "number.floor", description = "Floor of the number", example = "print 3.7.floor")]
    #[method]
    pub fn floor(&self) -> f64 {
        self.value.floor()
    }
    
    #[docs(name = "number.ceil", description = "Ceiling of the number", example = "print 3.3.ceil")]
    #[method]
    pub fn ceil(&self) -> f64 {
        self.value.ceil()
    }
    
    #[docs(name = "number.round", description = "Rounds the number to the nearest integer", example = "print 3.5.round")]
    #[method]
    pub fn round(&self) -> f64 {
        self.value.round()
    }
    
    #[docs(name = "number.sqrt", description = "Square root of the number", example = "print 16.sqrt // 4")]
    #[method]
    pub fn sqrt(&self) -> f64 {
        self.value.sqrt()
    }
    
    #[docs(name = "number.pow", description = "Raises the number to the power of exp", example = "print 2.pow(3) // 8")]
    #[method]
    pub fn pow(&self, exp: f64) -> f64 {
        self.value.powf(exp)
    }
    
    #[docs(name = "number.sin", description = "Sine of the number (in radians)", example = "print (3.14159 / 2).sin() // ~1")]
    #[method]
    pub fn sin(&self) -> f64 {
        self.value.sin()
    }
    
    #[docs(name = "number.cos", description = "Cosine of the number (in radians)", example = "print 0.0.cos() // 1")]
    #[method]
    pub fn cos(&self) -> f64 {
        self.value.cos()
    }
    
    #[docs(name = "number.tan", description = "Tangent of the number (in radians)", example = "print 0.0.tan() // 0")]
    #[method]
    pub fn tan(&self) -> f64 {
        self.value.tan()
    }

    #[docs(name = "number.percent", description = "Converts a decimal number to percentage", example = "print 0.85.percent() // 85.0")]
    #[method]
...
impl ArrayContext {
    ...
    #[docs(name = "array.length", description = "Length of the array", example = "print my_array.length")]
    #[property]
    pub fn length(&self) -> f64 {
        self.items.len() as f64
    }
    
    #[docs(name = "array.first", description = "Returns the first element of the array", example = "print my_array.first")]
    #[method]
    ...
    #[docs(name = "array.last", description = "Returns the last element of the array", example = "print my_array.last")]
    #[method]
    ...
    #[docs(name = "array.is_empty", description = "Checks if the array is empty", example = "if my_array.is_empty { print \"Array is empty\" }")]
    #[method]
    pub fn is_empty(&self) -> bool {
        self.items.is_empty()
    }
    
    #[docs(name = "array.sum", description = "Calculates the sum of numeric elements in the array", example = "print my_array.sum")]
    #[method]
    pub fn sum(&self) -> f64 {
