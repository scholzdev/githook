//! # GitHook Procedural Macros
//!
//! Procedural macros for the GitHook DSL implementation.
//!
//! ## Overview
//!
//! This crate provides procedural macros used internally by GitHook to:
//!
//! - Generate documentation metadata from attributes
//! - Register built-in functions automatically
//! - Export macros with module namespacing
//! - Implement context object methods with automatic type conversion
//!
//! ## Macros
//!
//! ### `#[docs]`
//!
//! Attaches documentation metadata to functions and structs that will be
//! exposed in the GitHook LSP for hover information and completion.
//!
//! ```rust,ignore
//! #[docs(name = "file.size", description = "Get file size in bytes")]
...
//! ### `#[builtin]`
//!
//! Registers a function as a built-in function available in GitHook scripts.
//! The function is automatically added to the builtin registry.
//!
//! ```rust,ignore
//! #[builtin]
//! fn file(args: &[Value]) -> Result<Value> {
//!     // Implementation
//! }
//! ```
//!
//! ### `#[export_macro]`
//!
//! Exports a function as a GitHook macro with optional module namespacing.
//!
//! ```rust,ignore
//! #[export_macro(module = "git")]
//! fn check_branch_name() -> Macro {
...
//! ### `#[callable_impl]`
//!
//! Implements methods on context objects that can be called from GitHook scripts.
//! Automatically generates method dispatch logic and type conversions.
//!
//! ```rust,ignore
//! #[callable_impl]
//! impl FileContext {
...
/// Pass-through attribute macro for documentation metadata.
///
/// This macro is used to attach documentation that will be extracted
/// by the LSP server for providing hover information and completions.
