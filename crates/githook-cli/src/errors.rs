...
pub fn enhance_error(
    ...
    if message.contains("Variable") && message.contains("not found") {
        enhanced =
            enhanced.with_suggestion("Check variable name spelling or declare it with 'let'");
        ...
        enhanced = enhanced
            .with_suggestion("Define the macro with 'macro name(params) { ... }' or import it");
        ...
        enhanced =
            enhanced.with_suggestion("Check syntax - missing semicolon, bracket, or keyword?");
        ...
        enhanced =
            enhanced.with_suggestion("Create a hook file with 'touch .githook/pre-commit.ghook'");
